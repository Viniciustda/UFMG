...
Original file is located at
    https://colab.research.google.com/drive/1GWbyF_TE-LHAoC3KtIgAlkpWK7HtvJTV
...
def high_delay(df):
    ...
    media_tempo_voo_rota = good.groupby(['OriginAirportName', 'DestAirportName'])['Q5'].mean()
    rota_maior_tempo_medio = media_tempo_voo_rota.idxmax()

    return rota_maior_tempo_medio
...
novo_df = df.dropna().query('Cancelled == 0').copy()

plt.scatter(novo_df.DepDelay, novo_df.ArrDelay, edgecolor='k', alpha=0.75)
plt.xlabel('DepDelay')
plt.ylabel('ArrDelay')