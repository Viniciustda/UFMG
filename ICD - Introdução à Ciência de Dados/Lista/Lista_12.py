...
Original file is located at
    https://colab.research.google.com/drive/11l5MmqL9v7YUxevDqq7PRKkW8GbLyfZn
"""
...
def derivadas_regressao_reg(theta, X, y, beta):
    return -2 * (X.T @ (y - X @ theta)) + 2 * beta * theta

"""#### Exercício 2

Agora, vamos relembrar a implementação do gradiente descendende:
"""
...
def gd_reg(theta, d_fun, X, y, beta, lambda_=0.0001, tol=0.00001, max_iter=10000):
    ...
    i = 0
    while True:
        # Computar as derivadas com regularização
...
assert_equal(np.round(r2_test,1), np.round(0.7148,1))
