...
Original file is located at
    https://colab.research.google.com/drive/16C0i8RFYMOpfdcpQIGsvQiLVAaqYjLxz
...
def sst(y):
    y_media = sum(y) / len(y)
    sst = sum((yi - y_media) ** 2 for yi in y)
...
def sse(x, y, param):
  ...
  sse_value = sum((yi - y_hat_i) ** 2 for yi, y_hat_i in zip(y, y_hat))
