...
Original file is located at
    https://colab.research.google.com/drive/1iyJsLscwvj7cRHKFC4T6zsmXkzpu1nF1
...
def linear_regression(x, y):
  # deve retornar uma tupla contendo os paramentros (alpha, beta)
...
def error_verification(alpha, beta, x, y):
  ...
  y_b = x * beta + alpha
  erro = y - y_b
  maiores = (erro[erro > 0]).count()
  menores = (erro[erro < 0]).count()
