...
class UseDefVisitor(Visitor):
    ...
    def visit_fn(self, exp, defined):
        inner_defined = defined | {exp.param}  # Adiciona o parâmetro ao conjunto de definidas
        return exp.body.accept(self, inner_defined)
    
    def visit_app(self, exp, defined):
        fn_undefined = exp.fn.accept(self, defined)    # Variáveis indefinidas na função
        arg_undefined = exp.arg.accept(self, defined)  # Variáveis indefinidas no argumento
        return fn_undefined | arg_undefined
